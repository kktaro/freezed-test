...
/// @nodoc
abstract class $ExampleStateCopyWith<T, $Res> {
  factory $ExampleStateCopyWith(
          ExampleState<T> value, $Res Function(ExampleState<T>) then) =
      _$ExampleStateCopyWithImpl<T, $Res, ExampleState<T>>;
}

/// @nodoc
class _$ExampleStateCopyWithImpl<T, $Res, $Val extends ExampleState<T>>
    implements $ExampleStateCopyWith<T, $Res> {
...
class __$$DataCopyWithImpl<T, $Res>
    extends _$ExampleStateCopyWithImpl<T, $Res, _$Data<T>>
...
class _$Data<T> with DiagnosticableTreeMixin implements Data<T> {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ExampleState<$T>.data(value: $value)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'ExampleState<$T>.data'))
...
abstract class Data<T> implements ExampleState<T> {
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$ExampleStateCopyWithImpl<T, $Res, _$Loading<T>>
...
class _$Loading<T> with DiagnosticableTreeMixin implements Loading<T> {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ExampleState<$T>.loading()';
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'ExampleState<$T>.loading'));
  }
...
abstract class Loading<T> implements ExampleState<T> {
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$ExampleStateCopyWithImpl<T, $Res, _$Error<T>>
...
class _$Error<T> with DiagnosticableTreeMixin implements Error<T> {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ExampleState<$T>.error(exception: $exception)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ExampleState<$T>.error'))
...
abstract class Error<T> implements ExampleState<T> {
  const factory Error(final Exception exception) = _$Error<T>;
